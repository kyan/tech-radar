...
const Radar = function (size, radar) {
  ...
  const BLIP_PATHS = {
    ...
    moved_in_third_quadrant: 'M421,311.1l14.1-10.2c0.1-0.1,0.1-0.2,0.1-0.3l-5.4-16.5c0-0.1-0.1-0.2-0.2-0.2h-17.4c-0.1,0-0.2,0.1-0.2,0.2l-5.4,16.5c0,0.1,0,0.2,0.1,0.3l14.1,10.2C420.8,311.2,420.9,311.2,421,311.1z',
