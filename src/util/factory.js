...
const sheetUrl =
  "https://docs.google.com/spreadsheets/d/1Qle0jpHR81-GHH_FPU2uCkdxYRZfFGjBY5aCTg36Lc0";
...
const GoogleSheet = function (sheetReference, sheetName) {
  ...
  self.build = function () {
    Papa.parse(`${sheetReference}/pub?output=csv`, {
      download: true,
      header: true,
...
function plotErrorMessage(exception) {
  ...
  var content = d3.select("body").append("div").attr("class", "error-page");
  ...
  if (exception instanceof MalformedDataError) {
    ...
    message =
      "Your window is too small to render the data. Please enlarge the window size and refresh.";
  } else {
